...
namespace wan24.Crypto
{
        ...
        : DisposableBase()
    {
        ...
        public byte[] GetStorableValue()
        {
            ...
            return ValueProtection.Protect(secureValue.Array, ValueProtection.Scope.User);
        }
        ...
        public static UserSecret FromStoredValue(
            in byte[] value,
            in TimeSpan? encryptTimeout = null,
            in TimeSpan? recryptTimeout = null,
            in CryptoOptions? options = null
            )
            => new(ValueProtection.Unprotect(value, ValueProtection.Scope.User), encryptTimeout, recryptTimeout, options);
    }
}
