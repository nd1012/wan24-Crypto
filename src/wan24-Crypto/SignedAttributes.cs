...
namespace wan24.Crypto
{
    ...
    public static partial class SignedAttributes
    {
        ...
        /// </summary>
        [DisplayText("Domain - Should contain the domain name of the PKI (yourcompany.com, for example)")]
        ...
        /// </summary>
        [DisplayText("OwnerId - Should contain an owner identifier, which can be used to query owner meta data from a store (binary values may be base64 encoded and encrypted, for example)")]
        ...
        /// </summary>
        [DisplayText("KeyValidationUri - Should contain a public https URI which targets a RESTful API for key validation (should receive the (possibly base64 encoded) key ID as path component and answer, if the key was revoked by returning the revokation timestamp (UTC DateTime ticks) or zero, if it wasn't revoked)")]
        ...
        /// a key AND sign)
        /// </summary>
        [DisplayText("GrantedKeyUsages - Should contain the numeric value of the granted AsymmetricAlgorithmUsages flags for the signed key (an asymmetric algorithm may be able to exchange a key AND sign)")]
        ...
        /// </summary>
        [DisplayText("KePublicKey - Should contain the (base64 encoded?) public key identifier of the key which is granted for key exchange with this signed key owner")]
        ...
        /// </summary>
        [DisplayText("KePublicCounterKey - Should contain the (base64 encoded?) public counter key identifier of the key which is granted for key exchange with this signed key owner")]
        ...
        /// </summary>
        [DisplayText("SigPublicKey - Should contain the (base64 encoded?) public key identifier of the key which is granted for signatures from this signed key owner")]
        ...
        /// </summary>
        [DisplayText("SigPublicCounterKey - Should contain the (base64 encoded?) public counter key identifier of the key which is granted for signatures from this signed key owner")]
        ...
        /// </summary>
        [DisplayText("CipherSuite - Should contain the (base64 encoded?) granted/confirmed cipher suite (CryptoOptions) of this signed key owner")]
        ...
        /// </summary>
        [DisplayText("Serial - Should contain the numeric key revision of the owner (not an overall PKI key counter)")]
        public const string SERIAL = "Serial";
        /// <summary>
        /// Permitted to sign sub-keys?
        /// </summary>
        [DisplayText("PkiSig - Permitted to sign sub-keys?")]
