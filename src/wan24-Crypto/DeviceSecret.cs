...
namespace wan24.Crypto
{
    ...
    public sealed class DeviceSecret(
        in byte[] value,
        ...
        : DisposableBase()
    {
        ...
        public byte[] GetStorableValue()
        {
            ...
            return ValueProtection.Protect(secureValue.Array, ValueProtection.Scope.System);
        }
        ...
        public static DeviceSecret FromStoredValue(
            in byte[] value,
            in TimeSpan? encryptTimeout = null,
            in TimeSpan? recryptTimeout = null,
            in CryptoOptions? options = null
            )
            => new(ValueProtection.Unprotect(value, ValueProtection.Scope.System), encryptTimeout, recryptTimeout, options);
    }
}
