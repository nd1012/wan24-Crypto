    ...
    public partial class CryptoOptions
    {
        ...
        protected override void Serialize(Stream stream)
        {
            stream.WriteSerializedNullable(Compression)
                //TODO Enable after stream serializer update .WriteNumber(MaxUncompressedDataLength)
        ...
        protected override async Task SerializeAsync(Stream stream, CancellationToken cancellationToken)
        {
            ...
            //TODO Enable after stream serializer update await stream.WriteNumberAsync(MaxUncompressedDataLength, cancellationToken).DynamicContext();
        ...
        protected override void Deserialize(Stream stream, int version)
        {
            ...
            //TODO Enable after stream serializer update
            /*switch (((IStreamSerializerVersion)this).SerializedObjectVersion ?? VERSION)// Serializer version switch
            {
                case 2:
